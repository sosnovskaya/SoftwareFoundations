...
Proof.
  apply E_Seq with (t_update empty_st X 0).
  - apply E_Ass. reflexivity.
  - apply E_Seq with (t_update (t_update empty_st X 0) Y 1).
    + apply E_Ass. reflexivity.
    + apply E_Ass. reflexivity.
Qed.
(** [] *)
...
Proof.
  apply E_Seq with (t_update (t_update empty_st X 2) Y 0).
  - apply E_Ass. reflexivity.
  - apply E_WhileTrue with (t_update (t_update (t_update (t_update empty_st X 2) Y 0) Y 2) X 1).
    + reflexivity.
    + apply E_Seq with (t_update (t_update (t_update empty_st X 2) Y 0) Y 2).
      * apply E_Ass. reflexivity.
      * apply E_Ass. reflexivity.
    + apply E_WhileTrue with (t_update (t_update (t_update (t_update (t_update (t_update empty_st X 2) Y 0) Y 2) X 1) Y 3) X 0).
      * reflexivity.
      * apply E_Seq with  (t_update (t_update (t_update (t_update (t_update empty_st X 2) Y 0) Y 2) X 1) Y 3).
        { apply E_Ass. reflexivity. }
        { apply E_Ass. reflexivity. }
...
Example s_execute2 :
     s_execute (t_update empty_st X 3) [3;4]
