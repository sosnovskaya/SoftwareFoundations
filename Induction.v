...
(* Destrcut tactic is based on analysing each of possible value of variables. 
It's brute force in some way.
In Induction tactic if we accept the statement (theorem is true for n') 
and are able to show that the theorem is true for several specific cases( fos S n', O)
then we conclude that theorem is true for all n
*)
*)
