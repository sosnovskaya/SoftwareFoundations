...
intros l. induction l as [| n l' IHl'].
  - simpl. reflexivity.
  - simpl. rewrite <- IHl'. rewrite <- eqb_refl. simpl. reflexivity. 
Qed.
(** [] *)
...
Proof.
  intros s. induction s as [| n l IH].
  - simpl. reflexivity.
  - simpl. { induction n .
...
Proof.
 intros d x y o H. simpl. rewrite -> H. simpl. reflexivity.
Qed.
(** [] *)
End PartialMap.
